...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.game_active:
            ...
            self._reset_aliens_and_ship()

            # hide the mouse cursor
            pygame.mouse.set_visible(False)

    def _reset_aliens_and_ship(self):
        self.bullets.empty()
        self.aliens.empty()
        self._create_fleet()
    ...
    def _update_bullets(self):
        ...
        self._check_if_fleet_destroyed()
    ...
    def _check_if_fleet_destroyed(self):
        """If no aliens left clear bullets and create new fleet"""
        if not self.aliens:
            # Destroy existing bullets, create new fleet and increase game speed.
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        while current_y < (self.settings.screen_height - 3 * alien_height):
            self._create_row_of_aliens(alien_width, current_x, current_y)
            # Finished a row, reset x and increment y
            current_x = alien_width
            current_y += 2 * alien_height

    def _create_row_of_aliens(self, alien_width, current_x, current_y):
